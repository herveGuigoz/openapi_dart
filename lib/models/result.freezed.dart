...
// ignore: unused_element
  _ResultError<T> error<T>(dynamic error) {
...
class _$_ResultData<T> extends _ResultData<T> {
  const _$_ResultData(@nullable this.value) : super._();
...
abstract class _ResultData<T> extends Result<T> {
  const _ResultData._() : super._();
  const factory _ResultData(@nullable T value) = _$_ResultData<T>;
...
abstract class _ResultError<T> extends Result<T> {
  ...
  const factory _ResultError(dynamic error) = _$_ResultError<T>;
